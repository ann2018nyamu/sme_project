...
public class SliderFragment2 extends Fragment {
    ...
    /**
     * Instantiates a new Slider fragment 2.
     */
    ...
    /**
     * New instance slider fragment 2.
     *
     * @return the slider fragment 2
     */
    public static SliderFragment2 newInstance() {
        return new SliderFragment2();
    }
    ...
    private void initImageView() {
        imgPreview.setImageResource(R.drawable.monitor);
    }
    /**
    ...
    private void initTextView() {
        ...
        txtTitle2.setText(R.string.monitor_settlement);
        txtTitle3.setText(R.string.customer_vendors);
        //setting typeface
